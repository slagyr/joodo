(defproject foo "0.1.0-SNAPSHOT"
  ...
  :cljsbuild ~(let [run-specs ["bin/specljs"  "public/javascript/foo_dev.js"]]
          {:builds {:dev {:source-paths ["src/cljs" "spec/cljs"]
                               :compiler {:output-to "public/javascript/foo_dev.js"
                                          :optimizations :whitespace
                                          :pretty-print true}
                          :notify-command run-specs}
                     :prod {:source-paths ["src/cljs"]
                             :compiler {:output-to "public/javascript/foo.js"
